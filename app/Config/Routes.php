...
$routes->group('peserta', ['filter' => 'role:admin,staff'], static function (RouteCollection $routes): void {
...
// berkas fotonya.
$routes->group('peserta', ['filter' => 'role:admin'], static function (RouteCollection $routes): void {
